...
import { LayoutDashboard, Package, Tag, Settings, LogOut, ShoppingBag, MessageCircle } from 'lucide-react';
...
const AdminLayout = () => {
    ...
    const navItems = [
        ...
        { label: 'Pedidos', icon: <ShoppingBag size={20} />, href: '/admin/orders' },
        { label: 'Produtos', icon: <Package size={20} />, href: '/admin/products' },
        { label: 'Categorias', icon: <Tag size={20} />, href: '/admin/categories' },
        { label: 'WhatsApp', icon: <MessageCircle size={20} />, href: '/admin/whatsapp' },
